...
COMPILER_CXX = 'g++'
CPP = '/usr/bin/cpp'
CPPFLAGS = ['-DNDEBUG', '-DHAVE_JPEG=1']
CPPFLAGS_NODE = ['-D_GNU_SOURCE']
CPPPATH_CAIRO = ['/usr/include/cairo', '/usr/include/pixman-1', '/usr/include/freetype2', '/usr/include/directfb', '/usr/include/libpng12']
...
HAVE_CAIRO = 1
LIBDIR = '/home/andy/.node_libraries'
...
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/andy/.node_libraries'
PREFIX = '/usr/local'
